...
angular
  ...
  .factory("SuscriptorFactory", function(
    $http,
    $q,
    $window,
    globalService,
    ...
    factory.buscarSuscriptor = function(obj) {
      ...
      $http
        .post(
          globalService.getUrl() + paths.buscarSuscriptor,
          JSON.stringify(obj),
          config
        )
    ...
    factory.getTerminals = function(id) {
      ...
      $http
        .post(
          globalService.getUrl() + paths.getTerminals,
    ...
    factory.getSuscriptorList = function() {
      ...
      $http
        .post(globalService.getUrl() + paths.getSuscriptorList,data, config)
        .then(function(response) {
          deferred.resolve(response.data);
        })
        .catch(function(data) {
