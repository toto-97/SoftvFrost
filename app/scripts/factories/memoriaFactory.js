...
angular
  ...
  .factory('memoriaFactory', function ($http, $q, globalService, $localStorage) {
    ...
    var paths = {
      ...
      GetAparatosTecnicoCambio: '/ObtieneTiposImagenes/GetAparatosTecnicoCambio',
      ...
      GetGeneraFolioMemoriaTecnicaVS: '/BuscaMemoriaTecnica/GetGeneraFolioMemoriaTecnicaVS',
      GetActualizaEstatusMemoriaTecnica: '/GuardaMemoriaTecnica/GetActualizaEstatusMemoriaTecnica',
      GetGuardaObservacionMemoriaTecnicaListPestana: '/GuardaObservacionMemoriaTecnica/GetGuardaObservacionMemoriaTecnicaListPestana',
      GetReporteMemoriasRechazadas: '/BuscaMemoriaTecnica/GetReporteMemoriasRechazadas',
      GetReporteMemoriasRechazadasExcel: '/BuscaMemoriaTecnica/GetReporteMemoriasRechazadasExcel'
    };
    ...
    factory.GetAparatosActuales = function (Tipo,ClvOrden,IdTecnico,IdMemoriaTecnica) {
      var deferred = $q.defer();
      var config = {
        headers: {
          'Authorization': $localStorage.currentUser.token
    ...
    factory.GetAparatosTecnicoCambio = function (Tipo,ClvOrden,IdTecnico,IdMemoriaTecnica) {
      var deferred = $q.defer();
      var config = {
        headers: {
          'Authorization': $localStorage.currentUser.token
      ...
      $http.post(globalService.getUrl() + paths.GetAparatosTecnicoCambio,JSON.stringify(Parametros),config).then(function (response) {
        deferred.resolve(response.data);
      }).catch(function (data) {
        deferred.reject(data);
      });
