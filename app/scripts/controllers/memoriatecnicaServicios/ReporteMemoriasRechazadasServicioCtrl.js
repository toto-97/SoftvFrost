...
angular.module('softvFrostApp')
    .controller('ReporteMemoriasRechazadasServicioCtrl', function ($http, reportesFactory, $timeout, ngNotify, $state, memoriaServicioFactory, $uibModal, globalService, usuarioFactory) {
        var vm = this;
        GeneraReporte();
        init();
        ...
        function DescargarReporte() {
            ...
            memoriaServicioFactory.GetReporteMemoriasRechazadasExcel(parametros).then(function (data) {
                console.log(data);
                var urlReporte = data.GetReporteMemoriasRechazadasExcelServicioResult;
                ...
                if (isChrome) {
                    ...
                    downloadLink.attr('download', 'ReporteMemoriasRechazadasReporte.xlsx');
                    downloadLink[0].click();
                } else if (isEdge || isIE) {
                    window.navigator.msSaveOrOpenBlob(vm.url, 'ReporteMemoriasRechazadasReporte.xlsx');
        ...
        function GeneraReporte() {
            ...
            memoriaServicioFactory.GetReporteMemoriasRechazadas(parametros).then(function (data) {
                vm.rowCollection4 = data.GetReporteMemoriasRechazadasServicioResult;
            });
        }
