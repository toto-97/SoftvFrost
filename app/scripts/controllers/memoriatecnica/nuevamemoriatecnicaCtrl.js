    ...
    function guardar() {
      var obj = {
        ...
        DomicilioNotificacion:
          isvalid(vm.domicilionotificacion) === true
        ...
        EstatusTecnico:
          isvalid(vm.estatustecnico) === true ? vm.estatustecnico : "",
        FechaActivacion:
          isvalid(vm.fechaactivacion) === true
            ? $filter("date")(vm.fechaactivacion, "yyyy/MM/dd")
            : "",
        VCNeutroTierra:
          isvalid(vm.vcneutrotierra) === true ? vm.vcneutrotierra : "",
        VCFaseTierra: isvalid(vm.vcfasetierra) === true ? vm.vcfasetierra : "",
        VCFaseNeutro: isvalid(vm.vcfaseneutro) === true ? vm.vcfaseneutro : "",
        VUPSNeutroTierra:
          isvalid(vm.upcneutrotierra) === true ? vm.upcneutrotierra : "",
        VUPSFaseTierra:
          isvalid(vm.upcfasetierra) === true ? vm.upcfasetierra : "",
        VUPSFaseNeutro:
          isvalid(vm.upcfaseneutro) === true ? vm.upcfaseneutro : "",
        ...
        Detalles:
          isvalid(vm.detalleinstalacion) === true ? vm.detalleinstalacion : "",
      ...
      memoriaFactory.GuardaMemoriaTecnica(obj).then(function(response) {
        vm.IdMemoriaTecnica =
          response.GetGuardaMemoriaTecnicaListResult[0].IdMemoriaTecnica;
        var file_options = [];
        var files = [];
        var tipos = [];
        var count = 0;
        ...
        if (count > 0) {
          ...
          memoriaFactory
            ...
            .then(function(data) {
              ngNotify.set(
                "las imagenes se han guardado correctamente",
                "success"
              );
